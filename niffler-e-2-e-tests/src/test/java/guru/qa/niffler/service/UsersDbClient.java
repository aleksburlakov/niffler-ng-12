...
public class UsersDbClient implements UsersClient {
  ...
  public UserJson updateUser(UserJson user) {
    UserEntity updatedUser = userdataUserRepository.update(UserEntity.fromJson(user));
  ...
  public void deleteUser(UserJson user) {
    xaTransactionTemplate.execute(() -> {
      AuthUserEntity authUserEntity = authUserRepository.findByUsername(user.username()).get();
